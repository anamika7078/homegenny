...
/**
 * An orphan from an earlier shape of the app — it drove `calculatePayroll` and
 * `queuePayrollBatch`, neither of which is how payroll runs now. Payroll is one
 * screen: Finance → Payroll. See ONE_STAFF_MODEL_PLAN.md §F6.
 */
    ...
    <div className="page-padding flex min-h-[60vh] flex-col items-center justify-center gap-4 text-center">
      ...
      <div className="space-y-1">
        ...
        <p className="max-w-md text-xs text-secondary-foreground">
          Payroll now runs in one place, from the attendance each staff member worked.
        </p>
      </div>
      <Link
