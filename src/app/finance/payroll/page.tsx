    ...
    <div className="page-padding space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-0.5">EOR monthly payroll · ESIC · PF · Razorpay disbursement</p>
        </div>
      ...
      <div className="rounded-2xl border border-white/8 bg-[#131c2e] overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 gap-3">
            ...
            <p className="text-slate-400 text-sm">No payroll records for {MONTHS[month - 1]} {year}</p>
